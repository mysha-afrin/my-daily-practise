...
print(my_num1 | my_num2)#This operation also indicates union.
print(my_num1.intersection(my_num2))
print(my_num1 & my_num2)#This operation also indicates intersection.

print(my_num1 - my_num2)
print(my_num1.difference(my_num2))
